  ...
  Widget build(BuildContext context) {
    var searchField = ClipRRect(
      ...
      child: Container(
        ...
        child: TextFormField(
          style: TextStyles.font14blackRreg,
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(
              color: isDark ? Colors.white70 : AppColorsLight.appDarkGrayColor,
              fontSize: 14,
              fontFamily: fontSelection(),
            ),
            errorStyle: const TextStyle(color: AppColorsLight.appDarkRedColor),
          ),
        ),
      ),
    );
